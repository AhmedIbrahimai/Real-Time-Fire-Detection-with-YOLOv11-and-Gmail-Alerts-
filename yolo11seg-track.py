...
def send_email(receiver_email, frame, max_retries=3, delay=5):
    ...
    while attempt < max_retries:
        try:
            ...
            server.login('ai4432463@gmail.com', 'wmyb mpri pnzm krju')  # Update with your credentials(sender_mail,password) 

            # Create the email
            msg = MIMEMultipart()
            msg['From'] = 'ai4432463@gmail.com'  # Update with your email
            ...
            for box, track_id, class_id, mask in zip(boxes, track_ids, class_ids, masks):
                ...
                if mask.size > 0:
                    ...
                    if 'fire' in c:
                        ...
                        receiver_email = "ai4432463@gmail.com"  # Update with the actual receiver email
